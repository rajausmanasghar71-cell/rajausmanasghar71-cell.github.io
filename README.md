...
<head>
    ...
    <title>Raja Usman Asghar - Personal Website</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h1 { text-align: center; color: #60a5fa; margin-bottom: 10px; font-size: 32px; }
        ...
        .value { direction: ltr; text-align: left; flex: 
